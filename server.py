    ...
    for i, video in enumerate(videos):
        ...
        try:
            req.patch(
                ...
                json={"horarios": [f"{data_str} {horario_str}"]},
                timeout=10
            )
...
def salvar_configuracoes():
    ...
    ig_config = data.get("ig_config", {"inicio": ig_hora_inicio, "fim": "22:00", "qtd": 5})
...
def iniciar_threads():
    ...
    threading.Thread(target=ig_reels_loop, daemon=True).start()
