...
def salvar_configuracoes():
    ...
    for cfg in configs_para_salvar:
        try:
            ...
            print(f"✅ Config salva: {cfg['chave']}")
        except Exception as e:
            print(f"❌ Erro ao salvar config {cfg['chave']}: {e}")
